...
让 AI 角色不只活在虚构里——通过 MCP（Model Context Protocol），你的 AI 伙伴可以查到**真实世界的当前时间和天气**，把"两点多了，外面在下小雨"这样的细节自然嵌进对话里，让角色扮演更有沉浸感。

NyaaChat 默认接入 [NyaaChat-MCP](https://github.com/NyaaCaster/NyaaChat-MCP) 服务，提供两个工具：
